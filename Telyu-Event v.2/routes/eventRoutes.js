...
router.get('/organization', authControl.protect, eventControl.getEventByEventHandler);

// Protected routes
router.post('/register/:eventId', authControl.protect, eventControl.registerForEvent);
router.post('/midtrans/notification', eventControl.handleMidtransNotification);
